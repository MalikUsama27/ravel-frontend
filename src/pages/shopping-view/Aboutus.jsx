...
<div className="mt-8">
  ...
  <p className="mt-4 text-lg md:text-xl text-gray-700 leading-relaxed text-justify">
    At RARE SIGNS APPAREL, we are dedicated to sustainability, ethical practices, and delivering exceptional products that stand the test of time. Join us on our journey to bring comfort, performance, and innovation to your wardrobe.
  </p>
</div>
        ...
        <p className="text-lg leading-relaxed text-gray-700 text-center mb-6">
        <span className="font-bold text-red-700">RARE SIGNS APPAREL</span> is a passionate team of sports enthusiasts, engineers, and designers who share a common goal: to revolutionize sportswear and hosiery products.
        </p>
